...
# === METADATA ===
PKG_NAME="cmatrix"
DESCRIPTION="this is a simple text editor called star
after install the script will run always check code before installing
to your system"
AUTHOR="n0b0dy-arch-btw"
REPO_URL="https://github.com/n0b0dy-arch-btw/star"
...
# === Installation Steps ===
STEP_1="mkdir -p ~/myfolder && git clone https://github.com/n0b0dy-arch-btw/star.git ~/myfolder"
STEP_2=""
STEP_3=""
STEP_4=""
STEP_5=""
